...
public class Server  implements ActionListener{
	...
	Server()
	{
		...
		Image img1 = i3.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
		...
		Image img2 = i5.getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT);
		...
		Image img3 = i7.getImage().getScaledInstance(35, 30, Image.SCALE_DEFAULT);
		...
		Image img4 = i9.getImage().getScaledInstance(10, 25, Image.SCALE_DEFAULT);
		ImageIcon i10 = new ImageIcon(img4);
		JLabel  morevert =  new JLabel(i10);
